...
export const steps = [
  {
    chip: "Oral and Maxillofacial Surgery",
    title: "Book Appointment",
    text: "Schedule your visit online or by phone at your convenience.",
  },
  {
    chip: "STEP 02",
  ...
  {
    chip: "STEP 04",
    title: "Enjoy a Bright Smile",
    text: "Schedule your visit online or by phone at your convenience.",
  },
];

export const transformationTabs = [
  { label: "Invisalign Treatment", icon: "tooth", pairs: [1, 2, 3] },
  { label: "Veneers & Bonding", icon: "kit", pairs: [4, 5, 6] },
  { label: "Pediatric Transformations", icon: "capsules", pairs: [7, 8, 9] },
  { label: "Teeth Whitening", icon: "microscope", pairs: [1, 5, 9] },
];
...
export const footerLinks = {
  ...
  hours: [
    { day: "Sun To Thurs:", time: "4PM To 10PM" },
    { day: "Saturday:", time: "2PM To 10PM" },
