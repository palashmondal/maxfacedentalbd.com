...
export const posts: BlogPost[] = [
  ...
  },
  {
    ...
    takeaway:
      "আক্কেল দাঁতের সিদ্ধান্ত নিন এক্স-রে দেখে, বিশেষজ্ঞের পরামর্শে। ম্যাক্সফেস ডেন্টাল কেয়ারে এমএস ডিগ্রিধারী ওরাল অ্যান্ড ম্যাক্সিলোফেসিয়াল সার্জন ডা. যশিতা মজুমদার নিজে আক্কেল দাঁতের সার্জারি করেন। পরীক্ষা করাতে অ্যাপয়েন্টমেন্ট নিন।",
  },
  {
